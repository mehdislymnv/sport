               ...
               <div class="col-md-9">
                  <div class="feature-post">
                     <div class="feature-img">
                        <img src="<?= get_template_directory_uri() ?>/assets/images/img-03_002.jpg" class="img-responsive" alt="#" />
                     </div>
                     <div class="feature-cont">
                        <div class="post-people">
                           <div class="left-profile">
                              <div class="post-info">
                                 <img src="<?= get_template_directory_uri() ?>/assets/images/profile-img.png" alt="#" />
                                 <span>
                  ...
                  <div class="feature-post small-blog">
                     <div class="col-md-5">
                        <div class="feature-img">
                           <img src="<?= get_template_directory_uri() ?>/assets/images/post2.png" class="img-responsive" alt="#" />
                        </div>
                     </div>
                     <div class="col-md-7">
                        <div class="feature-cont">
               ...
               <div class="col-md-3">
                  ...
                  <div class="blog-sidebar">
                     ...
                     <div class="category-menu">
                        <ul>
                           <li>
                              <span><img src="<?= get_template_directory_uri() ?>/assets/images/profile-img2.png" alt="#"></span>
                              <span>
                  ...
                  <aside id="sidebar" class="left-bar">
                     <div class="banner-sidebar">
                        <img class="img-responsive" src="<?= get_template_directory_uri() ?>/assets/images/match-banner1.jpg" alt="#">
                        <h3>Argentina vs Chile|Goals of the match | COPA </h3>
                     </div>
                  </aside>
                  <aside id="sidebar" class="right-bar">
                     <div class="banner">
                        <img class="img-responsive" src="<?= get_template_directory_uri() ?>/assets/images/adds-3.jpg" alt="#">
                     </div>
                  </aside>
                  <aside id="sidebar" class="left-bar">
                     <div class="feature-matchs">
